...
def copy_from_csv(conn, cursor, table_name, csv_file_path):
    #Open the csv file
    with open(r'C:\Users\syedk\Documents\investigation_project_v2\homicide_news_data.csv', 'r', encoding='ISO-8859-1') as file:
...
def connect():
    ...
    try:
        ...
        copy_from_csv(connection, csr, 'homicide_news_data', r'C:\Users\syedk\Documents\investigation_project_v2\homicide_news_data.csv')
